...
// Hero banners — real products featured first, then categories
const BANNERS = [
  {
    id: 1,
    title: "Oud Royale EDP",
    subtitle: "Premium oud wood — Rs 2,550",
    gradient: "from-[#fef3b0] via-[#fff3d0] to-[#fff8e7]",
    accentColor: "#e8734a",
    image: "/images/products/perfumes/p1.jpg",
    link: "/product/oud-royale-eau-de-parfum",
    emoji: "🧴",
  },
  {
    id: 2,
    title: "Crimson Blaze EDP",
    subtitle: "Fiery & passionate — Rs 3,000",
    gradient: "from-[#fff8e7] via-[#fef3b0] to-[#e8734a]/15",
    accentColor: "#e8734a",
    image: "/images/products/perfumes/p5.jpg",
    link: "/product/crimson-blaze-eau-de-parfum",
    emoji: "🔥",
  },
  {
    id: 3,
    title: "Ivory Bloom EDP",
    subtitle: "Graceful florals — Rs 3,500",
    gradient: "from-[#fff3d0] via-[#fef3b0] to-[#fff8e7]",
    accentColor: "#fef3b0",
    image: "/images/products/perfumes/p9.jpg",
    link: "/product/ivory-bloom-eau-de-parfum",
    emoji: "🌸",
  },
  {
    id: 4,
    title: "Cotton Bedsheets",
    subtitle: "5 PC King Size — Rs 1,750",
    gradient: "from-[#61ce70]/10 via-[#fef3b0] to-[#fff8e7]",
    accentColor: "#61ce70",
    image: "/images/products/bedsheets/b1.jpg",
    link: "/product/export-quality-cotton-bedsheet-set-1",
    emoji: "🛏️",
  },
  {
    id: 5,
    title: "Opal Musk EDP",
    subtitle: "Pure white musk — Rs 3,200",
    gradient: "from-[#fff8e7] via-[#fff3d0] to-[#fef3b0]",
    accentColor: "#e8734a",
    image: "/images/products/perfumes/p8.jpg",
    link: "/product/opal-musk-eau-de-parfum",
    emoji: "✨",
  },
  {
    id: 6,
  ...
  {
    id: 8,
    title: "Amber Noir EDP",
    subtitle: "Dark & intoxicating — Rs 3,000",
    gradient: "from-[#191510]/10 via-[#fef3b0] to-[#fff8e7]",
    accentColor: "#191510",
    image: "/images/products/perfumes/p11.jpg",
    link: "/product/amber-noir-eau-de-parfum",
    emoji: "🌙",
  },
];
